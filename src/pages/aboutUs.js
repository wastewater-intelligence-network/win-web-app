	...
	let about_us_data = {
		niua: [
			...
			},
			{
				...
				about_url:
					"https://www.linkedin.com/in/shilpa-shashidharan-b2537279/",
			...
			},
			{
				...
				name: "Abhiskha Das",
				about_url:
					"https://www.linkedin.com/in/abhisikha-das-579327154/",
			...
			},
			{
				...
				about_url:
					"https://www.linkedin.com/in/yogada-joshi-428637157/",
		...
		nwg: [
			...
			// },
			{
				...
				address:
					"6-E, Malviya Industrial Area, Jaipur, Rajastan,  302017",
			},
		],
		swg: [
			{
		...
		<>
			...
			<Box className="customeMarginBottom about">
				...
				<Typography variant="h6" className="aboutContent">
					Wastewater Intelligence Network is an initiative to bring
					together experts to manage the spread and impact of
					SARS-CoV-2 through Wastewater-based Epidemiology in Indian
					cities.
				</Typography>
				...
				<Box sx={{ textAlign: "left" }} className="p-0100">
					...
					<Typography variant="body2" className="wbeDetailsContent">
						<p>
							{" "}
							<span className="textBold">1-</span> SOPs for
							end-to-end adoption of WBE in a city
						</p>
						<p>
							{" "}
							<span className="textBold">2-</span> Enhancement of
							data-led decision making by geospatial data
							dashboard
						</p>
						<p>
							{" "}
							<span className="textBold">3-</span> Real-time
							status of the on-ground situation for optimised
							pandemics’ management{" "}
						</p>
						<p>
							{" "}
							<span className="textBold">4-</span> Knowledge
							sharing and proactive collaboration with domain
							experts through the national and city-specific
							working groups
						</p>
					</Typography>
				</Box>
							...
							<Grid item xs={12} sm={6} md={4}>
								<Card className={"aboutCard"}>
									<CardContent>
										...
										<Typography className="mycardSubHeading"></Typography>
