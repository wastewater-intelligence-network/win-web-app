				...
				<Box className="" sx={{ mt: 3, mb: 3 }}>
					...
					>
						<Grid item sm={12} xs={12} md={6} lg={9}>
							<Typography
								variant="h4"
								className="knowledge_sub_heading"
							>
								Sub Heading
							</Typography>
							...
							<Typography
								variant="h4"
								className="knowledge_2nd_sub_heading"
							>
								Sub Heading 2
							</Typography>
							<p className="knowledge_content">
								We use wastewater-based epidemiology (WBE) which
								analyses wastewater to determine exposure to
								pathogens in a population. This is done by
								collecting samples of wastewater from sewers,
								STPs, lakes etc. and testing these samples for
					...
					<Box className="box_section">
						<Grid container spacing={2} columnSpacing={0}>
							...
							<Grid item sm={7} xs={12} md={9}>
								...
								<p className="knowledge_content">
									We use wastewater-based epidemiology (WBE)
									which analyses wastewater to determine
									exposure to pathogens in a population. This
									is done by collecting samples of wastewater
									from sewers, STPs, lakes etc. and testing
									these samples for the presence of pathogens.
								</p>
								<p className="knowledge_content">
									We use wastewater-based epidemiology (WBE)
									which analyses wastewater to determine
									...
									>
										<Grid item xs={12} md={4}>
											<img
												alt="last"
												src={Image6}
												className="image-responsive last-image-mobile"
											/>
										</Grid>
										<Grid item xs={12} md={8}>
											...
											<p className="knowledge_content">
												We use wastewater-based
												epidemiology (WBE) which
												analyses wastewater to determine
												exposure to pathogens in a
												population. This is done by
												collecting samples of wastewater
												from sewers, STPs, lakes etc.
												and testing these samples for
												the presence of pathogens.
											</p>
										</Grid>
									</Grid>
