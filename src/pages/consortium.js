		...
		<>
			<Box className="consortium-main">
				...
				<Typography className="consortium-text">
					Wastewater Based Epidemiology is not a new concept. It is a
					tried and tested method across the world by various
					scientists to determine the presence of pathogens,
					consumption patterns and exposure to chemicals in the
					population by analysing wastewater. In India, there are
					various experts and institutions working on the prevalence
					of SARS-CoV-2 in wastewater and a considerable amount of
					research has gone into it. To implement wastewater
					surveillance using WBE smoothly in the cities, it is
					essential to ensure a concordance among the national and
					city experts and stakeholders. Hence to institutionalise
					health surveillance and to bolster the urban healthcare
					governance in Indian cities, the deployment in the city
					entails end-to-end strategies and processes for collecting
					and testing wastewater samples by bringing together medical
					experts, private companies, researchers, scientists and
					other relevant persons/institutions working in the field of
					WBE through the ‘WIN Consortium’. The consortium members
					will come together to design strategies, standardised
					protocols and support in the deployment of relevant
					infrastructure to track the outbreak of CoViD-19 and
					regularly occurring diseases that can be tracked through
					sewage. These members will also undertake and share their
					research developments related to methods and technologies in
					WBE.
				</Typography>

				<Typography className="consortium-text">
					The consortium is structured into two groups: The national
					working group and the City working group. The National
					working group will comprise members from research
					institutes, technical experts, knowledge partners and
					start-ups. They will act as an advisory body, helping the
					city in strategising the project and overseeing the
					project’s functioning in the city while providing inputs to
					the city stakeholders. The City working group will comprise
					members from the city who are enabling the project locally.
					This would include the municipal corporation or the smart
					city SPV, testing labs (testing partners), startups and
					associated departments for executing the project on the
					ground. NIUA is the governing body of the WIN Consortium and
					each city will govern the city working group and will also
					be members of the National Working Group.
				</Typography>
			</Box>
