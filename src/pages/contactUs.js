			...
			<Box className="address-block-main">
				...
				>
					<Grid
						...
						sm={4}
						md={4}
						className="address-block bg-white"
					>
					...
					<Grid
						...
						sm={4}
						md={4}
						className="address-block bg-blue"
					>
						<div className="logo-block">
							<img
								alt="NUIA"
					...
					>
						...
						<Typography variant="body2" className="address-desc">
							Surat Mahanagar Seva Sadan, Gordhandas Chokhawala
							Marg, Muglisara, Surat - 395003, Gujarat, India.
						</Typography>
						<Typography variant="body2" className="address-url-txt">
