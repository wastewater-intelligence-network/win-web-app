        ...
        >
          <Grid item xs={12} sm={12} md={6}>
            ...
            <Typography className="wbeDetailsContent" variant="h6">
              Indian cities have only taken baby steps in this vast pool of public health data that has been untouched for better governance. At every step there is a need to learn, improvise and customise the processes to choose an
            </Typography>
          </Grid>
          ...
          <Grid item xs={12} sm={12} md={12}>
            ...
            <Typography className="wbeDetailsContent moretext-cities" variant="h6">
              Indian city’s scenario. Therefore, WIN Programme aims to holistically approach the integration of the local authorities’ stronghold on local health operations, the larger vision of the centre and state towards better public health and the scientific and medical fraternity’s arduous efforts in bringing this research to suit India to systematise WBE as a method of tracking and staying informed and ahead of known but also newer pathogens and health hazards.
            </Typography>
