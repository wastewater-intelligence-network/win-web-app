  ...
  return (
		<>
			...
			<div className="Privacy">
				...
				<p>National Institute of Urban Affairs  ("us", "we", or "our") operates  (https://win.niua.org/) (the "Site") and the mobile app. This page informs you of our policies regarding the collection, use and disclosure of Personal Information we receive from users of the Site.</p>
				<p>We use your Personal Information only for providing and improving the Site and our app. By using the Site or app, you agree to the collection and use of information in accordance with this policy.</p>
				<p>Our Privacy Policy governs your visit to win.niua.org, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
				...
				<h4>2. Definitions</h4>
				<p>SERVICE means the win.niua.org website and using the app operated by National Institute of Urban Affairs.</p>
				...
				<ul>
					<li><p>0.1. Email address</p></li>
					<li><p>0.2. First name and last name</p></li>
					<li><p>0.3. Phone number</p></li>
					<li><p>0.4. Address, Country, State, Province, ZIP/Postal code, City</p></li>
					<li><p>0.5. Cookies and Usage Data</p></li>
				</ul>
				...
				<h4>Contact Us</h4>
				<p>If you have any questions about this Privacy Policy, please contact us by email: win@niua.org.</p>
