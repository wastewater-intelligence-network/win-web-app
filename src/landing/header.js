...
function Header(props) {
  ...
  const handleSelectMenu = (e, index) => {
    ...
    if (
      e.currentTarget.innerText === "Challenge" ||
      e.currentTarget.innerText === "CHALLENGE"
    ) {
      navigate("/challenge");
      ...
      e.currentTarget.innerText === "Home" ||
      e.currentTarget.innerText === "HOME"
    ) {
      navigate("/home");
      let _elm = document.getElementById(e.target.id);
      ...
      e.currentTarget.innerText === "About us" ||
      e.currentTarget.innerText === "ABOUT US"
    ) {
      navigate("/aboutus");
      // let _elm = document.getElementById(e.target.id);
      ...
      e.currentTarget.innerText === "Contact us" ||
      e.currentTarget.innerText === "CONTACT US"
    ) {
      navigate("/contactus");
      // let _elm = document.getElementById(e.target.id);
      ...
      e.currentTarget.innerText === "Consortium" ||
      e.currentTarget.innerText === "CONSORTIUM"
    ) {
      navigate("/consortium");
...
console.log(index + "testing index")
  ...
  const handleClickSurat = (event, index) =>{
    console.log(event.currentTarget.id);
   

    if(event.currentTarget.id === "cityitemsurat"){
      navigate("/surat");
    }
  ...
  return (
    <>
      ...
      <AppBar
        position="static"
        sx={{ boxShadow: 0, backgroundColor: "#555555", mb: 4 }}
      >
        <Container>
            ...
            <Box sx={{ flexGrow: 1, display: { xs: "flex", md: "none" } }}>
              ...
              >
                {pages.map((page, index) => (
                  <Box>
                    <MenuItem
                      className={index === 2 || index === 3 ? "hide" : "show"}
                      key={page}
                    ...
                    <div className={index === 2 ? "show" : "hide"}>
                      <Button
                        ...
                        className={
                          citydd === true ? "active_menu" : "no_active_menu"
                        }
                      >
                        Cities
                      </Button>
                ...
                <Box>
                  <Button
                    ...
                    className={classNames(
                      index === 2 || index === 4 ? "hide" : "show",
                      selectedid === "deskmenu" + index
                        ? "active_menu"
                        : "not_active_menu"
                    )}
                  ...
                  <div className={index === 2 ? "show" : "hide"}>
                    ...
                    >
                        <MenuItem id="cityitemsurat"  onClick={handleClickSurat}>
                          Surat
                        </MenuItem>
                  ...
                  <div className={index === 4 ? "show" : "hide"}>
                    <Button
                      ...
                      aria-controls={
                        openknowledge ? "basic-menu-knowledge" : undefined
                      }
                      aria-haspopup="true"
                      aria-expanded={openknowledge ? "true" : undefined}
                      onClick={handleClickKnowledge}
                      onMouseOver={handleClickKnowledge}
                      style={{
                        marginTop: "15px",
                        color: "#fff",
                      }}
                    ...
                    <Menu
                      ...
                      MenuListProps={{ onMouseLeave: handleCloseKnowledge }}
                    >
                      <MenuItem
                        id="wasteWaterBased"
